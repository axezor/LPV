...
// @updateURL       https://github.com/axezor/Steam-Next-Queue/raw/master/Other/Local_Picture_Viewer.user.js
// @downloadURL     https://github.com/axezor/Steam-Next-Queue/raw/master/Other/Local_Picture_Viewer.user.js
// ==/UserScript==
               ...
               // axezoraxe += ' style=\" opacity: 0.3;\" onmouseout=\"this.style.opacity=0.3;\" title=\"Upper\"  onmouseover=\"this.style.opacity=1;\"></a>';
                ...
                if (axezorzzx.match(/\.(jpg|jpeg|png|gif|exif|tiff|rif|bmp|dib|webp)/)) {
                    ...
                    if (axezordll[i].indexOf('icon dir') != -1) {
                        ...
                        //console.log('1____'+axezordll[i]);
                    } else {
                        axezordll[i] = axezordll[i].replace('a><', 'img><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<');
                        //console.log('2____'+axezordll[i]);

                    }
                    
                    if(axezordll[i].indexOf('</td><td class="detailsColumn"') !== -1){
                        var b = axezordll[i].split('</td>');
                    ...
                    axezordlk = axezorggg;
                      ...
                      //console.log(axezorair[axezorzxc]);
